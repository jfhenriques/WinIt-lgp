<?php
	 ...
	 */
	DEFINE('INCLUSION_PATH_SIMPLE', '/billsystem');
	 ...
	 */
	DEFINE('PDO_DATABASE', 'mysql:host=localhost;dbname=disco_billsystem;charset=UTF-8' );
	DEFINE('PDO_USERNAME', 'billsystem6278');
	DEFINE('PDO_PASSWORD', 'MzntTeRCwf6abPEM');
