...
--
-- Host: localhost
-- Generation Time: Apr 16, 2013 at 05:49 AM
...
CREATE TABLE IF NOT EXISTS `address` (
  ...
  `llll` int(6) NOT NULL,
  PRIMARY KEY (`adid`),
  UNIQUE KEY `uq_moradas_cp4_cp3_rua_llll` (`cp4`,`cp3`,`address`,`llll`),
...
--
ALTER TABLE `address`
  ADD CONSTRAINT `address_ibfk_1` FOREIGN KEY (`llll`) REFERENCES `cplocality` (`llll`);
