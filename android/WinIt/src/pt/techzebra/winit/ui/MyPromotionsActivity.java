...
public class MyPromotionsActivity extends SherlockFragmentActivity implements OnItemClickListener {
	...
	private static final int NUM_STEPS_ = 3;
	private static int step_;
	...
	public static class MyPromotionsStepFragment extends SherlockFragment{
		...
		public void onActivityCreated(Bundle savedInstanceState) {
			...
			if(step_ == 0){
				...
				((MyPromotionsActivity) activity).page_title_ = (TextView) activity.findViewById(R.id.page_title2);
				...
				((MyPromotionsActivity) activity).page_title_ = (TextView) activity.findViewById(R.id.page_title3);
				((MyPromotionsActivity) activity).page_title_.setText("Tradeable Promotions");
